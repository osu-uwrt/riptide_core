...
TEST(ArduinoLibTest, TestMap)
{
    ...
    arduino_lib::map<arduino_lib::string, arduino_lib::string> m = ARDUINOLIB_MAP(
        ...
        arduino_lib::pair<arduino_lib::string, arduino_lib::string>("ab", "12"),
        arduino_lib::pair<arduino_lib::string, arduino_lib::string>("cd", "34"),
        arduino_lib::pair<arduino_lib::string, arduino_lib::string>("ef", "56"));
