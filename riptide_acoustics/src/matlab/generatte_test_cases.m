...
base_vector = [0.2, 0.0, 0.0];

%initial pose of hydrophone 1
%make sure to convert from ros quat to matlab quat
pose1_h1 = [0,0,0,1,-0.0001,0.0002,0.001];

%second pose of hydrophone 2
pose2_h1 = [3.1644,0,0,.9992,0.0402,0,0];

%pinger pose
pose_pinger = [1, 7,-1,0,0,0,0];
...
[solve_x_p, solve_y_p] = solve_two_pulse_system_depth(delta_d1, delta_d2, pose1_h1', pose2_h1', base_vector', 1, [7.41; 7.3], pose_pinger(3));
[solve_x_n, solve_y_n] = solve_two_pulse_system_depth(delta_d1, delta_d2, pose1_h1', pose2_h1', base_vector', -1, [7.41; 7.3], pose_pinger(3));
